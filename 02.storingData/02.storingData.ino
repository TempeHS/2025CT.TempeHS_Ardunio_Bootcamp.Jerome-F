/*
  Author: Jerome Fakhoury 14-8-2024
  ...
  Success Criteria:
    ...
    3.  I Understand how (1, HIGH and true) and (0, LOW, false) all represent the same concept and can be
        ...
        I can convert an integer, float and boolean to a string and print it in to the serial monitor
...
bool myValue = false;
static unsigned long myunsignedLong = 3.141592653597932384626433;
